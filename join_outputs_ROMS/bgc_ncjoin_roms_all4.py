...
file_prefix = ['ussw1_bdiags_avg','ussw1_his','ussw1_phys_flux','ussw1_avg']
#file_prefix = ['ussw1_bdiags_avg','ussw1_his','ussw1_phys_flux']

# path here
out_path1 = '/data/project3/kesf/ROMS/USSW1/'
