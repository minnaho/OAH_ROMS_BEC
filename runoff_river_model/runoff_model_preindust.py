...
coef = pd.read_csv('Coef_preindustrial.txt',header=None)
co_agr = coef[0][0]
co_com = coef[0][1]
co_ind = coef[0][2]
co_ope = coef[0][3]
...
# write to csv files
###################
savepath = '/data/project1/minnaho/river_data/updated_2013_2017/rational_method_rivers/runoff_model_output_preindust/'
for n_i in range(len(names)):
    ...
    riv_df.to_csv(savepath+names[n_i]+'_2007_2018_test.csv')
