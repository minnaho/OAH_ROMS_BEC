...
# for ussw1 biogeochemical model
...
TRAFILE  = 'usw_1km_tra'
RADFILE  = 'usw_1km_rad'
PRECFILE = 'usw_1km_prec'
BRYFILE  = 'ussw1_bryV1'
RSTFILE  = 'ussw1_rst'
pCO2_atm = 'pco2_1994-2011.nc'

grid_file = 'usw1_grd.nc'
...
# bulk_forcing
atm_wind = 'usw_1km_wnd_'
atm_tra  = 'usw_1km_tra_'
atm_rad  = 'usw_1km_rad_'
atm_prec = 'usw_1km_prec_'
frc      = 'usw1_frc.nc'
dust     = 'ussw1_dust.nc'

# OUTFILES
HISFILE     = 'ussw1_his.nc'
HISBIOFILE  = 'ussw1_his_BIO.nc'
AVGFILE     = 'ussw1_avg.nc'
#AVGBIOFILE  = 'ussw1_avg_BIO.nc'
AVGBIOFILE  = 'ussw1_avg_bio.nc'
BULKHISNAME = 'ussw1_bdiags_his.nc'
BULKAVGNAME = 'ussw1_bdiags_avg.nc'
HISDIAG     = 'ussw1_eddy_his.nc'
AVGDIAG     = 'ussw1_eddy_avg.nc'
AVGPHYSNAME = 'ussw1_phys_flux.nc'

bgc_flux_his = 'ussw1_bgc_flux_his.nc'
bgc_flux_avg = 'ussw1_bgc_flux_avg.nc'

phys_flux_his = 'ussw1_phys_flux_his.nc'
...
for y in range(start_year,end_year+1):
	...
	f.write('auxiliary_history_fields: rho Omega W  Akv Akt Aks  HBL HBBL\n')
        ...
        f.write('            '+newfile+'   '+NTSAVG+'   '+NAVG+'    '+NRPFAVG+'\n')
        ...
        f.write('                       '+newfile_bda+'    '+ntsavg_bda+'       '+navg_bda+'   '+nrpfavg_bda+'\n')
