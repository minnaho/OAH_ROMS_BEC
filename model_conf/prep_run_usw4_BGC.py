...
atm_tra  = 'usw42_tra_'
atm_rad  = 'usw42_rad_'
atm_prec = 'usw42_prec_'
frc      = 'usw1_frc.nc'
dust     = 'usw42_dust.nc'

# OUTFILES
HISFILE     = 'usw42_his.nc'
HISBIOFILE  = 'usw42_his_BIO.nc'
AVGFILE     = 'usw42_avg.nc'
#AVGBIOFILE  = 'usw42_avg_BIO.nc'
AVGBIOFILE  = 'usw42_avg_bio.nc'
BULKHISNAME = 'usw42_bdiags_his.nc'
BULKAVGNAME = 'usw42_bdiags_avg.nc'
HISDIAG     = 'usw42_eddy_his.nc'
AVGDIAG     = 'usw42_eddy_avg.nc'
AVGPHYSNAME = 'usw42_phys_flux.nc'

bgc_flux_his = 'uswc4_bgc_flux_his.nc'
bgc_flux_avg = 'uswc4_bgc_flux_avg.nc'

phys_flux_his = 'usw42_phys_flux_his.nc'
