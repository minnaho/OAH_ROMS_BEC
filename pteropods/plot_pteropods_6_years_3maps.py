...
'''
exp_files = ['pteropods_behavior_L1_omega_1.2_1days.nc',
             'pteropods_behavior_L1_omega_1.2_7days.nc',
             'pteropods_behavior_L1_omega_1.5_7days.nc',
             'pteropods_behavior_L1_omega_1_7days.nc',
             'pteropods_behavior_L1_omega_1_30days.nc',
             'pteropods_behavior_L1_omega_1.2_30days.nc']

exp_titles = ['Pteropod Severe Dissolution, Threshold: 1.2, Duration: 1 day',
              'Pteropod Severe Dissolution, Threshold: 1.2, Duration 7 days',
              'Pteropod Mild Dissolution, Threshold: 1.5, Duration: 7 days',
              'Pteropod Growth, Threshold: 1, Duration: 7 days',
              'Pteropod Growth, Threshold: 1, Duration: 30 days',
              'Pteropod Severe Dissolution, Threshold 1.2, Duration: 30 days']
'''
...
'''
'''
exp_files = ['pteropods_shelldiss_mild_juvenile_100m_1997_2006.nc',
             'pteropods_shelldiss_mild_juvenile_200m_1997_2006.nc',
             'pteropods_survival_adult_100m_1997_2006.nc',
             'pteropods_survival_adult_200m_1997_2006.nc']
'''
...
exp_titles = ['Adult Survival 0-200 m depth May to Jun, Threshold: 0.95, Duration: 14 days',
              'Juvenile Mild Shell Dissolution 0-200 m depth Apr to May, Threshold: 1.5, Duration: 5 days']
