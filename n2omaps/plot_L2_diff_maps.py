...
savename = 'n2o_L2_diff_'+depth+'_M'+'%02d'%month+'.png'

if month == 6:
    titlestr = 'June Average DIFF '+depth+' 2013-2017'
if month == 7:
    titlestr = 'July Average DIFF '+depth+' 2013-2017'
if month == 8:
    titlestr = 'August Average DIFF '+depth+' 2013-2017'

file_nc = '/data/project4/minnaho/extract_roms/n2o_diff/l2_scb_avg.M'+'%02d'%month+'_2013_2017_'+depth+'.nc'
#v_max = 0.01
...
plot_im = ax.pcolormesh(lon_nc,lat_nc,data_nc,transform=ccrs.PlateCarree(),cmap=c_map,vmin=v_min,vmax=v_max)
