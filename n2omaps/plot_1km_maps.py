...
savename = 'n2o_L1_'+depth+'_M'+'%02d'%month+'.png'

if month == 6:
    titlestr = 'June Average '+depth+' 1997-2017'
if month == 7:
    titlestr = 'July Average '+depth+' 1997-2017'
if month == 8:
    titlestr = 'August Average '+depth+' 1997-2017'
...
#h_c2 = [1000]
#hplt2 = ax.contour(lon_nc,lat_nc,h_nc,h_c2,colors='lightgray')
#ax.clabel(hplt2,colors='lightgray',inline=True,fmt='%d')
