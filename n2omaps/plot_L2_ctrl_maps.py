...
savename = 'n2o_L2_ctrl_'+depth+'_M'+'%02d'%month+'.png'

if month == 6:
    titlestr = 'June Average CTRL '+depth+' 2013-2017'
if month == 7:
    titlestr = 'July Average CTRL '+depth+' 2013-2017'
if month == 8:
    titlestr = 'August Average CTRL '+depth+' 2013-2017'

file_nc = '/data/project4/minnaho/extract_roms/l2_noap/slices/l2_scb_avg.M'+'%02d'%month+'_2013_2017_'+depth+'.nc'
#v_max = 0.01
