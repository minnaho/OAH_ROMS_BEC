...
savename = './figs/inputs_compare_season_1997_2013_brokeny.pdf'
...
axes[0].text(x_ind[0]+(2*width),r_season_tnn[0]+offset0,format(np.floor(r_season_tnn[0]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
axes[0].text(x_ind[1]+(2*width),r_season_tnn[1]+(offset0-600000),format(np.floor(r_season_tnn[1]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
axes[0].text(x_ind[2]+(2*width),r_season_tnn[2]+(offset0-800000),format(np.floor(r_season_tnn[2]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
axes[0].text(x_ind[3]+(2*width),r_season_tnn[3]+(offset0-800000),format(np.floor(r_season_tnn[3]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')


axes[0].text(x_ind[0]+(width),p_season_tnn[0]-(offset0*530),format(np.floor(p_season_tnn[0]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
axes[0].text(x_ind[1]+(width),p_season_tnn[1]-(offset0*530),format(np.floor(p_season_tnn[1]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
axes[0].text(x_ind[2]+(width),p_season_tnn[2]-(offset0*510),format(np.floor(p_season_tnn[2]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
axes[0].text(x_ind[3]+(width),p_season_tnn[3]-(offset0*500),format(np.floor(p_season_tnn[3]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
