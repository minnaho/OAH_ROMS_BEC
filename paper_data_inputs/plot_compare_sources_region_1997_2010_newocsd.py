...
#if log_set == True:
ax[0].set_yscale('log')
ax[0].set_ybound(lower=1E5,upper=1E8)
ax[1].set_yscale('log')
...
ax[0].text(x_ind[2],p_yr_kg_tn[2]-1.1E7,format(np.floor(p_yr_kg_tn[2]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
ax[0].text(x_ind[3],p_yr_kg_tn[3]-1.45E7,format(np.floor(p_yr_kg_tn[3]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
ax[0].text(x_ind[4],p_yr_kg_tn[4]-1.4E7,format(np.floor(p_yr_kg_tn[4]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
...
ax[0].text(x_ind[7],p_yr_kg_tn[7]-4.9E7,format(np.floor(p_yr_kg_tn[7]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
...
ax[0].text(x_ind[3]+width,r_yr_kg_tn[3]+1E5,format(np.floor(r_yr_kg_tn[3]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
ax[0].text(x_ind[4]+width,r_yr_kg_tn[4]+1E5,format(np.floor(r_yr_kg_tn[4]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
...
ax[0].text(x_ind[6]+width,r_yr_kg_tn[6]+1E5,format(np.floor(r_yr_kg_tn[6]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
ax[0].text(x_ind[7]+width,r_yr_kg_tn[7]+8E5,format(np.floor(r_yr_kg_tn[7]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
...
ax[1].text(x_ind[5],p_yr_kg_tp[5]+3E4,format(np.floor(p_yr_kg_tp[5]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
...
ax[1].text(x_ind[3]+width,r_yr_kg_tp[3]+2E4,format(np.floor(r_yr_kg_tp[3]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
ax[1].text(x_ind[4]+width,r_yr_kg_tp[4]+1.5E4,format(np.floor(r_yr_kg_tp[4]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
...
ax[1].text(x_ind[6]+width,r_yr_kg_tp[6]+2E4,format(np.floor(r_yr_kg_tp[6]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
ax[1].text(x_ind[7]+width,r_yr_kg_tp[7]+1E5,format(np.floor(r_yr_kg_tp[7]).astype(int),',d'),fontsize=12,rotation=90,horizontalalignment='center')
