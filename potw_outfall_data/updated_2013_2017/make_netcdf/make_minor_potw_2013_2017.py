...
newf = Dataset('minor_potw_data_2013_2017.nc','w')
...
# flow
sbr_fl_noninterp = sbr_df[52][3:ind_end+3].replace(to_replace='NODI: B',value=np.nan).astype(float)*mgd_to_m3s
sbr_fl = np.array(sbr_fl_noninterp.interpolate().values.ravel().tolist())
