...
# PNDN and FNDN only for all plants except ocsd and ti
ndn_paths_major = [major_excel_pndnno,major_excel_fndnno]
ndn_paths_minor = [minor_excel_pndnno,minor_excel_fndnno]

# only OCSD and Terminal Island PNDN/FNDN
nore_paths_major = [major_excel_pndnre,major_excel_fndnre]
nore_paths_minor = [minor_excel_pndnre,minor_excel_fndnre]

# reycle 50 and 90% paths
recy_paths_major = [major_excel_pndn50,major_excel_pndn90,major_excel_fndn50,major_excel_fndn90]
recy_paths_minor = [minor_excel_pndn50,minor_excel_pndn90,minor_excel_fndn50,minor_excel_fndn90]
...
# majors without ocsd
major_path = [major_excel_pndnno,major_excel_fndnno,major_excel_pndn50,major_excel_pndn90,major_excel_fndn50,major_excel_fndn90]

# minors without Terminal Island
minor_path = [minor_excel_pndnno,minor_excel_fndnno,minor_excel_pndn50,minor_excel_pndn90,minor_excel_fndn50,minor_excel_fndn90]

#  ocsd
ocsd_path = [major_excel_pndnre,major_excel_fndnre,major_excel_pndn50,major_excel_pndn90,major_excel_fndn50,major_excel_fndn90]
