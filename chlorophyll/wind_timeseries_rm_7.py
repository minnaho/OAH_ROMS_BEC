...
N = 168 # number of hours in 7 days
wind_1999_rm_7 = np.convolve(wind_1999_flat,np.ones((N,))/N, mode='valid')
wind_2007_rm_7 = np.convolve(wind_2007_flat,np.ones((N,))/N, mode='valid')
...
rot = 15
title = '7 Day Running Mean of Wind Speed between (33.15$\degree$,-119.05$\degree$), (33.25$\degree$,-118.9$\degree$)'

# change by 6 days to make date match running mean
n = N-24
# start at n days later
...
ax1.plot(dates_1999,wind_1999_rm_7[:n_hours_1999])
...
ax2.plot(dates_2007,wind_2007_rm_7[:n_hours_2007])
#locator = mdate.YearLocator()
...
plt.savefig(save_figs+'wind_timeseries_rm_7.png',bbox_inches='tight')
...
plt.plot(dates_1999[feb1:jun30],wind_1999_rm_7[feb1:jun30])
ax = plt.gca()
...
plt.savefig(save_figs+'wind_timeseries_rm_7_1999.png',bbox_inches='tight')
