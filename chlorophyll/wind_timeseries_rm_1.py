...
# find running mean with 1 day window
N = 24 # number of hours in 1 days
wind_1999_rm_1 = np.convolve(wind_1999_flat,np.ones((N,))/N, mode='valid')
wind_2007_rm_1 = np.convolve(wind_2007_flat,np.ones((N,))/N, mode='valid')
...
rot = 15
title = '1 Day Running Mean of Wind Speed between (33.15$\degree$,-119.05$\degree$), (33.25$\degree$,-118.9$\degree$)'

# change by 23 hours to make date match running mean
n = N-1
# start at n hours later
dates_1999 = dates_1999[n:]
dates_2007 = dates_2007[n:]
n_hours_1999 = n_hours_1999-n
n_hours_2007 = n_hours_2007-n

f, (ax1,ax2) = plt.subplots(2,1,figsize=(14,8),sharey=True)
ax1.plot(dates_1999,wind_1999_rm_1[:n_hours_1999])
...
ax2.plot(dates_2007,wind_2007_rm_1[:n_hours_2007])
#locator = mdate.YearLocator()
...
plt.savefig(save_figs+'wind_timeseries_rm_1.png',bbox_inches='tight')
...
plt.plot(dates_1999[feb1:jun30],wind_1999_rm_1[feb1:jun30])
ax = plt.gca()
...
plt.savefig(save_figs+'wind_timeseries_rm_1_1999.png',bbox_inches='tight')
