...
if option1==1
fout1 =   ['/data/project1/minnaho/decapods/extract_nc/pH_co2sys_L1_',num2str(DDfix),'m_slice.nc'];
ncvar='var';
shortname='pH';
...
fout2 =   ['/data/project1/minnaho/decapods/extract_nc/om_juranek_L1_',num2str(DDfix),'m_slice.nc'];
ncvar='var';
shortname='omega';
