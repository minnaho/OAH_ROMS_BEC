...
%% parameters
PAR1TYPE =  1 ; % alk
PAR2TYPE = 2 ; % dic 2 , pH 3
pHSCALEIN = 1 ;  % sea water scale
K1K2CONSTANTS = 10 ; % Millero et al, 2010  T:    0-depthlim  S:  1-depthlim. Seaw. scale. Real seawater.
KSO4CONSTANTS = 1 ; % KSO4 of Dickson & TB of Uppstrom 1979  (PREFERRED)
clear DATA
%% calculation
[DATA,HEADERS,NICEHEADERS]=CO2SYS(alk(:)/(1+0.0114),dic(:),PAR1TYPE,PAR2TYPE,...
    salt(:),temp(:),nan,...
    0,nan,...
    sio3(:),po4(:),...
    pHSCALEIN,...
