...
file_path_out = '/data/project1/minnaho/psource/source_attribution/roms_psource_mex.nc'
...
Qbar_nc_new = np.ones((numnew,29))*np.nan
NO3_nc_new = np.ones((numnew,29))*np.nan
NO2_nc_new = np.ones((numnew,29))*np.nan
NH4_nc_new = np.ones((numnew,29))*np.nan
DON_nc_new = np.ones((numnew,29))*np.nan
PO4_nc_new = np.ones((numnew,29))*np.nan
DOP_nc_new = np.ones((numnew,29))*np.nan
DOC_nc_new = np.ones((numnew,29))*np.nan
salt_nc_new = np.ones((numnew,29))*np.nan
Fe_nc_new = np.ones((numnew,29))*np.nan
Alk_nc_new = np.ones((numnew,29))*np.nan
O2_nc_new = np.ones((numnew,29))*np.nan
SiO3_nc_new = np.ones((numnew,29))*np.nan
temp_nc_new = np.ones((numnew,29))*np.nan
DIC_nc_new = np.ones((numnew,29))*np.nan
