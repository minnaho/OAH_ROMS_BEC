...
file_path_out = '/data/project1/minnaho/psource/newport_estuary/roms_psource_estuary.nc'
...
# only choose Aug 2010 - Mar 2012 (-1 and +1 month from start and end of model)
p_st = 163
p_en = 182
...
psrc_time_dim = file_out.createDimension('psrc_time',psource_time_nc[p_st:p_en].shape[0])
...
# psource loads for chosen time period
