...
psrc_fname='roms_psource_deep.nc';
...
i=5 ; % >80
pNH4(i,i,:) = (1000)* 0.01269223 ;
pNO3(i,i,:) = (1000)*0.400091;
pPO4(i,i,:) = (1000)*0.0179708;
pTON(i,i,:) = (1000)*0.497879;
pTOP(i,i,:) = (1000)*0.027535;
