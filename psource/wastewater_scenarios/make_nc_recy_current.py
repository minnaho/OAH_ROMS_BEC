...
# HTP : 2 diffusers
Qbar_nc[0,:]  = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*(5./28) 
Qbar_nc[1,:]  = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*(5./28) 
Qbar_nc[2,:]  = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*(5./28) 
Qbar_nc[17,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*(5./28) 

Qbar_nc[6,:]  = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[8,:]  = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[3,:]  = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[5,:]  = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[18,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[22,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 

Qbar_nc[4,:]  = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[7,:]  = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[9,:]  = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[19,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28)
Qbar_nc[20,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28)
Qbar_nc[21,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28)

Qbar_nc[23,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[26,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[14,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[16,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[13,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[11,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 

Qbar_nc[25,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[27,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[24,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[10,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[15,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[12,:] = major_htp_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 


# break up diffuser flow
# JWPCP : 3 diffusers
Qbar_nc[28,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*(5./14) 
Qbar_nc[29,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*(5./14) 
Qbar_nc[30,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*(5./14)
Qbar_nc[50,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*(5./14)
                                                                        
Qbar_nc[34,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./2)/14) 
Qbar_nc[32,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./2)/14) 
Qbar_nc[37,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./2)/14) 
Qbar_nc[39,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./2)/14) 
Qbar_nc[38,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./2)/14) 
Qbar_nc[41,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./2)/14) 
                                                                       
Qbar_nc[33,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./6)/14) 
Qbar_nc[35,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./6)/14) 
Qbar_nc[31,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./6)/14) 
Qbar_nc[36,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./6)/14) 
Qbar_nc[42,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./6)/14) 
Qbar_nc[40,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.65*((1./6)/14) 
                                                                        
Qbar_nc[51,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./2)/14)
Qbar_nc[54,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./2)/14)
Qbar_nc[47,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./2)/14)
Qbar_nc[49,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./2)/14)
Qbar_nc[46,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./2)/14)
Qbar_nc[44,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./2)/14)
                                                                       
Qbar_nc[43,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./6)/14)
Qbar_nc[48,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./6)/14)
Qbar_nc[45,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./6)/14)
Qbar_nc[55,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./6)/14)
Qbar_nc[53,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./6)/14)
Qbar_nc[52,:] = major_jwp_mon['flow final effluent m3/s'][p_st:p_en]*.35*((1./6)/14)
...
# PLWTP two diffusers
Qbar_nc[70,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*(5./28) 
Qbar_nc[72,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*(5./28) 
Qbar_nc[71,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*(5./28) 
Qbar_nc[87,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*(5./28) 
                                                    
Qbar_nc[76,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[78,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[73,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[75,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[88,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[92,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*(((1./2)+(1./6))/28) 
                                                    
Qbar_nc[74,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[77,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[79,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[89,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*(((1./2)+(1./6))/28) 
Qbar_nc[90,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[91,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
                                                    
Qbar_nc[83,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[81,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[86,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[84,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
Qbar_nc[95,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./2)/28) 
                        
Qbar_nc[80,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[85,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[82,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[93,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
Qbar_nc[94,:] = major_plw_mon['flow final effluent m3/s'][p_st:p_en]*((1./6)/28) 
