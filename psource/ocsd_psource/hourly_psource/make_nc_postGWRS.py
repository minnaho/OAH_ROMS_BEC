...
file_path_out = 'roms_psource_ocsd_hourly_postGWRS.nc'
...
# hourly post GWRS data MGD starting from 12am
gwrs_hrs = np.array((57.3, 56.7, 54.7, 51.9, 49.1, 46.8, 45.1, 44.2, 44.1, 45.2, 48.3, 53.1, 56.6, 57.8, 58.1, 57.7, 56.9, 56.0, 55.2, 54.7, 54.8, 55.2, 55.9, 56.7))
# constituents in mg/L
gwrs_bod = 5.256160336
gwrs_toc = 31.8000
gwrs_nh4 = 28.88
gwrs_onn = 5.474044159
gwrs_no3 = 38.02
gwrs_no2 = 13.17
gwrs_tpp = 4.290884571
gwrs_po4 = 2.9515
gwrs_opp = 1.3394
gwrs_sil = 76.7381
gwrs_alk = 853.3188
