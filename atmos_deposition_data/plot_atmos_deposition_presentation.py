...
p = m.pcolor(x,y,np.nanmean(oxn[11::12,:,:]*m2_to_km2,axis=0),cmap=cmap_redn,vmin=redn_vmin,vmax=redn_vmax) 
ax = plt.gca()
# draw details on map
m.drawstates()
m.drawcountries()
...
cb.set_label('Oxidized Nitrogen (mmol km$^{-2}$ s$^{-1}$)',fontsize=axis_font)
...
plt.savefig(save_figs_path+redn_path+'oxn_presentation_dec_clim_2002_2012.png',bbox_inches='tight')
