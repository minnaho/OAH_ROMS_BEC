...
p_major_din_ssd_old = np.nanmean(np.nansum(np.array(p_major_tn_old[0][0]),axis=0).reshape(ry0,12),axis=0)
p_major_din_nsd_old = np.zeros((12))
p_major_din_occ_old = np.nanmean(np.nansum(np.array(p_major_tn_old[2][0]),axis=0).reshape(ry0,12),axis=0)
p_major_din_spp_old = np.nanmean(np.nansum(np.array(p_major_tn_old[3][0]),axis=0).reshape(ry0,12),axis=0)
p_major_din_smm_old = np.nanmean(np.nansum(np.array(p_major_tn_old[4][0]),axis=0).reshape(ry0,12),axis=0)
...
#p_major_din_nsd = np.nanmean(np.nansum(np.array(p_major_tn[1][0]),axis=0).reshape(ry0,12),axis=0)
p_major_din_ssd_new = np.nanmean(np.nansum(np.array(p_major_tn_new[0][0]),axis=0).reshape(ry0,12),axis=0)
p_major_din_nsd_new = np.zeros((12))
p_major_din_occ_new = np.nanmean(np.nansum(np.array(p_major_tn_new[2][0]),axis=0).reshape(ry0,12),axis=0)
p_major_din_spp_new = np.nanmean(np.nansum(np.array(p_major_tn_new[3][0]),axis=0).reshape(ry0,12),axis=0)
p_major_din_smm_new = np.nanmean(np.nansum(np.array(p_major_tn_new[4][0]),axis=0).reshape(ry0,12),axis=0)
...
p_tnn_ssd_old = p_major_tnn_ssd_old+p_minor_tnn_ssd_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_nsd_old = p_major_tnn_nsd_old+p_minor_tnn_nsd_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_occ_old = p_major_tnn_occ_old+p_minor_tnn_occ_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_spp_old = p_major_tnn_spp_old+p_minor_tnn_spp_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_smm_old = p_major_tnn_smm_old+p_minor_tnn_smm_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_ven_old = p_major_tnn_ven_old+p_minor_tnn_ven_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_sbb_old = p_major_tnn_sbb_old+p_minor_tnn_sbb_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol

p_din_ssd_old = p_major_din_ssd_old+p_minor_tnn_ssd_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_nsd_old = p_major_din_nsd_old+p_minor_tnn_nsd_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_occ_old = p_major_din_occ_old+p_minor_tnn_occ_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_spp_old = p_major_din_spp_old+p_minor_tnn_spp_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_smm_old = p_major_din_smm_old+p_minor_tnn_smm_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_ven_old = p_major_din_ven_old+p_minor_tnn_ven_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_sbb_old = p_major_din_sbb_old+p_minor_tnn_sbb_old*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
...
p_tnn_ssd_new = p_major_tnn_ssd_new+p_minor_tnn_ssd_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_nsd_new = p_major_tnn_nsd_new+p_minor_tnn_nsd_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_occ_new = p_major_tnn_occ_new+p_minor_tnn_occ_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_spp_new = p_major_tnn_spp_new+p_minor_tnn_spp_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_smm_new = p_major_tnn_smm_new+p_minor_tnn_smm_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_ven_new = p_major_tnn_ven_new+p_minor_tnn_ven_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_tnn_sbb_new = p_major_tnn_sbb_new+p_minor_tnn_sbb_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol

p_din_ssd_new = p_major_din_ssd_new+p_minor_tnn_ssd_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_nsd_new = p_major_din_nsd_new+p_minor_tnn_nsd_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_occ_new = p_major_din_occ_new+p_minor_tnn_occ_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_spp_new = p_major_din_spp_new+p_minor_tnn_spp_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_smm_new = p_major_din_smm_new+p_minor_tnn_smm_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_ven_new = p_major_din_ven_new+p_minor_tnn_ven_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol
p_din_sbb_new = p_major_din_sbb_new+p_minor_tnn_sbb_new*s_to_d*d_to_mo*g_N*g_to_kg*mmol_to_mol

# yearly average
print('DIN ssd 1997-2000: ',np.nansum(p_din_ssd_old))
print('DIN nsd 1997-2000: ',np.nansum(p_din_nsd_old))
print('DIN occ 1997-2000: ',np.nansum(p_din_occ_old))
print('DIN spp 1997-2000: ',np.nansum(p_din_spp_old))
print('DIN smm 1997-2000: ',np.nansum(p_din_smm_old))
print('DIN ven 1997-2000: ',np.nansum(p_din_ven_old))
print('DIN sbb 1997-2000: ',np.nansum(p_din_sbb_old))

print('DIN ssd 2013-2017: ',np.nansum(p_din_ssd_new))
print('DIN nsd 2013-2017: ',np.nansum(p_din_nsd_new))
print('DIN occ 2013-2017: ',np.nansum(p_din_occ_new))
print('DIN spp 2013-2017: ',np.nansum(p_din_spp_new))
print('DIN smm 2013-2017: ',np.nansum(p_din_smm_new))
print('DIN ven 2013-2017: ',np.nansum(p_din_ven_new))
print('DIN sbb 2013-2017: ',np.nansum(p_din_sbb_new))
