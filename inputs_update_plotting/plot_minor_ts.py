...
minor_path = '/data/project1/minnaho/potw_outfall_data/updated_2013_2017/minor_potw_data/minor_potw_data.nc'
fig_path = './figs/'
...
plt.ion()
# din only
savename_major_flux = fig_path+'major_potw_ts_din_allyears.pdf'

fig,axes = plt.subplots(3,1,sharex=True,figsize=[figw,figh+5])
for p_i in range(len(major_names)):
    axes.flat[0].plot(major_time_dt[:iend_major],major_flo[:iend_major,p_i],linestyle=major_linesty[p_i],label=major_names[p_i],linewidth=lw)
    # din mg/L
    axes.flat[1].plot(major_time_dt[:iend_major],major_din[:iend_major,p_i]*g_N*mmol_to_mol,linestyle=major_linesty[p_i],label=major_names[p_i],linewidth=lw)
    # din kg/day
    axes.flat[2].plot(major_time_dt[:iend_major],major_flo[:iend_major,p_i]*major_din[:iend_major,p_i]*s_to_d*mmol_to_mol*g_to_kg*g_N,linestyle=major_linesty[p_i],label=major_names[p_i],linewidth=lw)
axes.flat[0].set_ybound(lower=0)
axes.flat[1].set_ybound(lower=0)
axes.flat[2].set_ybound(lower=0)
axes.flat[0].set_ylabel('Volume Flux\n m$^3$ s$^{-1}$',fontsize=axis_font)
axes.flat[1].set_ylabel('DIN\n mg L$^{-1}$',fontsize=axis_font)
...
ind_2013 = 15341
ind_2017 = iend_major
savename_major_flux = fig_path+'major_potw_ts_din_split.pdf'
...
for p_i in range(len(major_names)):
    ...
    # din mg/L
    axes.flat[2].plot(major_time_dt[ind_1997:ind_2000],major_din[ind_1997:ind_2000,p_i]*g_N*mmol_to_mol,linestyle=major_linesty[p_i],label=major_names[p_i],linewidth=lw)
    axes.flat[3].plot(major_time_dt[ind_2013:ind_2017],major_din[ind_2013:ind_2017,p_i]*g_N*mmol_to_mol,linestyle=major_linesty[p_i],label=major_names[p_i],linewidth=lw)
    # din kg/day
