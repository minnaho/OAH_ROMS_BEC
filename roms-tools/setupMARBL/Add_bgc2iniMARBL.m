...
%---------------------------------------------------------------------------------------
%
ininame = '/data/project8/pdamien/ROMS_outputs/PACMED25KMmarbl/FORCINGS/pacmed25_MARBL_ini19950105.nc' ;
...
BGCname3_vars = {'DON' 'DONr' 'DOP' 'DOPr' 'DOCr' 'NH4' 'DOC'} ;
BGCname3_coef = [ 1     0.8    0.1  0.003   1e-6  1e-6   1e-6] ;
%
%---------------------------------------------------------------------------------------
...
dens_ini = dens_t0 + coeft(3).*(dens_t1-dens_t0) ;
...
for v=1:length(BGCname1_vars)
    ...
    var_ini = var_t0 + coeft(3).*(var_t1-var_t0) ;
    clear var_t0 var_t1
