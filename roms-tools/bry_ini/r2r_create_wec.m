...
nccreate(inifile,'wwv_time','Dimensions',{'time',tdim},'datatype','single');
ncwriteatt(inifile,'wwv_time','long_name','surface gravity wave time');
ncwriteatt(inifile,'wwv_time','units','days');

nccreate(inifile,'Awave','Dimensions',{'xi_rho',Lp,'eta_rho',Mp,'time',tdim},'datatype','single');
...
nccreate(inifile,'Dwave','Dimensions',{'xi_rho',Lp,'eta_rho',Mp,'time',tdim},'datatype','single');
