% Vertical interpolation for lateral boundary condition values
  ...
  gname = '/data/project3/pdamien/ROMS_pdamien/config/KUROSHIO/kuroshio600m_grd.nc';
  fname = '/data/project3/pdamien/ROMS_pdamien/config/KUROSHIO/kuroshio600m_brysmooth2_20161231235452.nc';
...
%      ncwriteatt(oname,vname,'units',units)
    ...
    [h_bnd,bdimx] = get_hbnd(vname,h);
    z_bnd  = zlevs4(h_bnd,0*h_bnd,ts,tb,hc,nz,'r','new2008');
    zo_bnd = zlevs4(h_bnd,0*h_bnd,tso,tbo,hco,nzo,'r','new2008');
    z_bnd  = squeeze(z_bnd)';
