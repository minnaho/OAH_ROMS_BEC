...
grdfile = '/data/project8/pdamien/ROMS_outputs/ATLSMA25KM/FORCINGS/atlsma_grd.nc' ; 
rivfile = '/data/project8/pdamien/ROMS_outputs/ATLSMA25KM/FORCINGS/atlsma_riv.nc' ;
...
%%%%%%%%%%%% Northern Amercian Canada river %%%%%%%%%%%%%%%%%%%%
   % Saint-Lawrence Caniapiscau Albany Manicouagan La-Grande Ottawa Saguenay Eastmain Susquehanna
index = [         8          21     23          24        25     26       29       31          33 ...
         36       37  40];
   % George Nottaway Red
