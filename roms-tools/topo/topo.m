...
%   gridfile = '/paracas/ROMS_SOLUTIONS/NPAC2KM/FORCINGS/npac2km_grd.nc';
%   gridfile = '/paracas/ROMS_SOLUTIONS/STCC/FORCINGS/stcc_grd.nc' ;
   gridfile = 'SUBPAC_grd.nc' ;
...
%       datafile = '/avatar/nmolem/batavia/nmolem/OBSERV/TOPO/SRTM30_180.nc';
	...
	topo_lat = topo_lat(1,:);
      case{'srtm15'}
        ...
        datafile = '/paracas/DATASETS/SRTM15_V2.5.nc';
        topo_lon = ncread(datafile,'lon');
        topo_lat = ncread(datafile,'lat');
     end
