...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   frclist = dir([frc_dir frc_source '_1hr_Y*']);
...
%       lwr_mult(:,:,i) = interp2(lon_frc,lat_frc,corr_lwr',lon,lat,'makima');
   ...
   for i = 1:nfiles
     ...
     for irec = 1:nrecord
       ...
       % translate to days since Roms referecne time
       days = double(time)/24. + datenum(1900,1,1) - dateref ;
