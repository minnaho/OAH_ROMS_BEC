...
pdir    = '/data/project3/pdamien/ROMS_pdamien/config/SWELL/';
pname   = 'uswc1200_grd.nc';
ename   = 'uswc1200_edata.nc';

% Child grid directory and file name
cdir    = '/data/project3/pdamien/ROMS_pdamien/config/SWELL/';
cname   = 'mendocino300_grd.nc';
gname   = 'mendocino300' 
