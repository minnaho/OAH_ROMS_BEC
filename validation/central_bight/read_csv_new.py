...
csv_files = sorted(glob.glob('/data/project1/minnaho/validation/central_bight/C*.csv'))

# get only file names
#csv_files = [ f[f.index('a/')+2:] for f in csv_files_long]
#csv_files =csv_files_long 
'''
...
#df = df.drop(['Qual_EC','Qual_ENT','Qual_FC','Qual_NH3','Qual_TC','Void','Ammonia QA Batch'],axis=1)
...
dates_nc = date2num(date_list,'days since 1998-07-07')
...
xrs.to_netcdf('central_bight_master_database_1998_2017_1D_new.nc')
