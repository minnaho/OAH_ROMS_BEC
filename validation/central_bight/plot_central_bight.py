...
# variable
var_data_nc = data_file.variables[variable_name]
var_unit = var_data_nc.units
var_data = np.asarray(data_file.variables[variable_name])

# chosen month
##################
month_chosen = [12,1,2,3]
month_name = []
...
#########################################
data_slice = var_data[month_ind][:,loc_ind,:]
