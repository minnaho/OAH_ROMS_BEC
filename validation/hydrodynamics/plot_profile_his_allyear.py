...
la_tim = pickle.load(open('./moor_npy/la_moor_time.pkl','rb'))

la_prof_u = pickle.load(open('./moor_npy/la_u_prof.pkl','rb'))
la_prof_v = pickle.load(open('./moor_npy/la_v_prof.pkl','rb'))

la_dep = pickle.load(open('./moor_npy/la_dep_prof.pkl','rb'))
...
fig1,axes1 = plt.subplots(1,2,figsize=[figw,figh])
axes1.flat[0].plot(roms_avg_u_sum_oc,roms_dep_sum_oc,color=roms_c,label='ROMS')
axes1.flat[0].plot(roms_std_u_sum_oc_low,roms_dep_sum_oc,color=roms_c,linestyle=std_l)
axes1.flat[0].plot(roms_std_u_sum_oc_high,roms_dep_sum_oc,color=roms_c,linestyle=std_l)

axes1.flat[0].plot(oc_avg_u_sum,oc_dep_plt,color=moor_c,label='ADCP')
axes1.flat[0].plot(oc_std_u_sum_low,oc_dep_plt,color=moor_c,linestyle=std_l)
axes1.flat[0].plot(oc_std_u_sum_high,oc_dep_plt,color=moor_c,linestyle=std_l)

axes1.flat[0].set_xlabel('u m s$^{-1}$',fontsize=axis_font)
axes1.flat[0].set_ylabel('Depth',fontsize=axis_font)


axes1.flat[1].plot(roms_avg_v_sum_oc,roms_dep_sum_oc,color=roms_c)
axes1.flat[1].plot(roms_std_v_sum_oc_low,roms_dep_sum_oc,color=roms_c,linestyle=std_l)
axes1.flat[1].plot(roms_std_v_sum_oc_high,roms_dep_sum_oc,color=roms_c,linestyle=std_l)

axes1.flat[1].plot(oc_avg_v_sum,oc_dep_plt,color=moor_c)
axes1.flat[1].plot(oc_std_v_sum_low,oc_dep_plt,color=moor_c,linestyle=std_l)
axes1.flat[1].plot(oc_std_v_sum_high,oc_dep_plt,color=moor_c,linestyle=std_l)

axes1.flat[1].set_xlabel('v m s$^{-1}$',fontsize=axis_font)

#axes1.flat[0].legend(loc='lower left',fontsize=axis_font,bbox_to_anchor=[0,1.02,2.2,.102],ncol=2,mode='expand',borderaxes1pad=0.,handlelength=3)
axes1.flat[0].legend(loc='lower left',fontsize=axis_font,bbox_to_anchor=[0.6,1.02,1.1,.102],ncol=2,mode='expand',borderaxespad=0.,handlelength=3)

for i in range(len(axes1.flat)):
    axes1.flat[i].tick_params(axis='both',which='major',labelsize=axis_font)

fig1.savefig(fig_path+'oc_vertical_allyear_his.png',bbox_inches='tight')

# plot one la profile
fig0,axes0 = plt.subplots(1,2,figsize=[figw,figh])
...
axes0.flat[0].plot(la_u_avg[la_ch],la_dep_plt,color=moor_c,label='ADCP')
axes0.flat[0].plot(la_u_std_low[la_ch],la_dep_plt,color=moor_c,linestyle=std_l)
axes0.flat[0].plot(la_u_std_high[la_ch],la_dep_plt,color=moor_c,linestyle=std_l)
...
axes0.flat[1].plot(la_v_avg[la_ch],la_dep_plt,color=moor_c)
axes0.flat[1].plot(la_v_std_low[la_ch],la_dep_plt,color=moor_c,linestyle=std_l)
axes0.flat[1].plot(la_v_std_high[la_ch],la_dep_plt,color=moor_c,linestyle=std_l)
    
axes0.flat[0].set_xlabel('u m s$^{-1}$',fontsize=axis_font)
axes0.flat[0].set_ylabel('Depth',fontsize=axis_font)
...
fig0.savefig(fig_path+'la_vertical_allyear_his.png',bbox_inches='tight')
