...
out_path = '/data/project1/minnaho/validation/hydrodynamics/roms_slices/zslice_5_50m_1997_2000_avg/'
...
# la and oc moorings to show location on map
la_ch = 2
la_lat = np.load('./moor_npy/la_lat.npy')[la_ch]
la_lon = np.load('./moor_npy/la_lon.npy')[la_ch]
...
# plot OC/LA moorings
msize = 80
axes.flat[0].scatter(la_lon,la_lat,s=msize,marker='x',color='teal',linewidth=3)
axes.flat[0].scatter(oc_lon,oc_lat,s=msize,marker='o',edgecolors='teal',facecolor='None',linewidth=3)
axes.flat[1].scatter(la_lon,la_lat,s=msize,marker='x',color='teal',linewidth=3)
axes.flat[1].scatter(oc_lon,oc_lat,s=msize,marker='o',edgecolors='teal',facecolor='None',linewidth=3)


# plot bathymetry contours
#h_plt = axes.flat[0].contour(lon_nc,lat_nc,h_nc,h_c,colors='navy')
#axes.flat[0].clabel(h_plt,inline=True,fontsize=10,fmt='%1i')
...
axes.flat[0].set_title('summer surface',fontsize=axis_font+2)
axes.flat[1].set_title('winter surface',fontsize=axis_font+2)
