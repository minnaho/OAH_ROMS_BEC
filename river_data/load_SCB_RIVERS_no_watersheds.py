...
f0 = Dataset('south_coast_rivers_10_years_no_watershed.nc','w')
f1 = Dataset('south_coast_rivers_24_years.nc','w')
...
#f0.description = 'Rivers in this data set: 341-LAHarbor, 154-San_Juan_Crk, 151-LAHarbor, 345-Goleta_SanJose, 350-Montecito, 237-SanDiegoR, 257-Sweetwater, 109-Solstice Canyon, 32-LARiver, 345-Goleta_Atascadero, 189-Salt Creek, 98-little Sycamore, 34-StaAnaRiver, 119-Pena Canyon, 177-Moro Canyon, 85-Ballona_Crk, 262-Tijuana, Santa Margarita River, 143-LAHarbor, 285-MissionBay, 116-Tuna Canyon, 351-Rincon, 317-Marie Canyon, 45-Santa_Clara, 91-Santa Monica Canyon, 210-Aliso Canyon, 108-Las Flores Canyon, 267-MissionBay, 288-Otay, 256-LPL, 331-Encinas, 95- Arroyo Sequit, 141-SanDiegoCrk, 7-VenturaRiv, 130-RedondoBchKingHarbor, 354-Mission Creek, 112-Walnut Canyon, 101-Trancas canyon, 111-Carbon Canyon, 37-Calleguas, 36-SanGabrielR, 201-SanLuisReyR' 
...
#f1.description = 'Rivers in this data set: Agua Hedionda, Arroyo Trabuco, Bolsa Chica Westminster Channel, Bonita Creek, Buena Vista, Carpinteria, Chollas Creek, Costa Mesa Chanel, Coyote Creek, Cristianitos Creek, Devereux Lagoon, Dominguez, E Garden Grove Wintersberg Channel, Escondito Creek, Goleta Tecolotito, Laguna Canyon, Las Flores, Malibu Creek, Prima Desch, Revolon, San Dieguito, San Marcos Creek, San Mateo, San Onofre Creek, San Pedro Creek, Santa Ana Delhi, Segunda Desch, Tecolote Creek, Topanga, Zuma Canyon'
...
lat_c = f0.createDimension('lat',51)
lon_c = f0.createDimension('lon',51)

time_r = f1.createDimension('time',None)
lat_r = f1.createDimension('lat',24)
lon_r = f1.createDimension('lon',24)
...
f0.close()
f1.close()
print('Compilation data written to south_coast_rivers_10_years_no_watershed.nc')
print('Rational data written to south_coast_rivers_24_years.nc')
'''
