...
if option1==1
fout1 =   ['/data/project3/kesf/tools_matlab/applications/pteropods/om_co2sys_L1_',num2str(DDfix),'m.nc'];
create_netcdf3D_L1(fout1);
end
fout2 =   ['/data/project3/kesf/tools_matlab/applications/pteropods/om_juranek_L1_',num2str(DDfix),'m.nc'];
