...
fout2 =   '/data/project3/kesf/tools_matlab/applications/pteropods/om_juranek_L1_200m_2001_2002.nc';
create_netcdf3D_L1(fout2);

%% find the modle outputs directories
rep = '/data/project3/kesf/ROMS/USSW1/DAILY_2001_2002/' ;
%% list the model outputs
%repavg = dir([rep,'/ussw1_avg.Y1999*.nc']) ;
repavg = dir([rep,'/ussw1_avg.Y200*.nc']) ;
