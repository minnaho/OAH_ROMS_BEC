...
Frequency = ncread([dir_,'pteropods_growth.nc'],'Frequency') ;
Duration = ncread([dir_,'pteropods_growth.nc'],'Duration') ;
Severity = ncread([dir_,'pteropods_growth.nc'],'Severity') ;
...
link_cpt2='/data/project3/kesf/tools_matlab/matlab_paths/cpt_all/oc/';
cptc2 = 'sst.cpt' ;

link_cpt1='/data/project3/kesf/tools_matlab/matlab_paths/cpt_all/ncl/';
cptc1 = 'precip4_diff_19lev.cpt' ;

link_cpt3='/data/project3/kesf/tools_matlab/matlab_paths/cpt_all/imagej/';
cptc3 = 'cequal.cpt';

fig  = figure('visible','on','position',[0 0 750 550]);
...
set(cb,'position',[p(1) p(2)-0.07 p(3) p(4)/3]);
xlabel(cb,'Events')
...
figure_file_name = [dir_gr,'Growth'] ;
